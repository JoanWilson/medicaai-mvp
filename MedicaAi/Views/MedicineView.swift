...
struct MedicineView: View {
    ...
    @State private var healthCenters:[String] = ["Posto de Saúde Messejana", "Posto de Saúde Messejana", "Posto de Saúde Messejana", "Posto de Saúde Messejana", "Posto de Saúde Messejana"]
